...
| 11 | [Evaluation & Observability](Notes/11-Evaluation-and-Observability.mdx) | Trajectory eval, LLM-as-judge, metrics, observability stack, debugging | ★★★ Advanced |
| 12 | [Q&A Review Bank](Notes/12-Interview-QA-Bank.mdx) | 40 questions across 8 domains - concepts through production engineering | ★★★ |
