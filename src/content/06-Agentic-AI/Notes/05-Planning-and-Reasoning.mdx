...
```mermaid
flowchart TD
    G["🎯 Goal: Design a system for<br/>real-time fraud detection"]
    G --> A["Branch A<br/>Rule-based system"]
    G --> B["Branch B<br/>ML-based system"]
    A --> A1["A1: Fast, rigid<br/>score 5/10"]
    A --> A2["A2: Slow, flexible<br/>score 4/10"]
    B --> B1["B1: Streaming<br/>score 8/10 ✓ best fit"]
    B --> B2["B2: Batch<br/>score 6/10"]
    B1 --> S(["✅ Select B1 → continue expanding"])
