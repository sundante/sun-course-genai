# Code Labs - 01: AI Agent Types

Build single AI agents from scratch across three complexity levels in all four frameworks. Each level adds a new capability layer on top of the previous.

← **Back to Overview:** [Agents](../INDEX.md) · **Back to Concepts:** [AI Agent Fundamentals](../Notes/01-Agent-Fundamentals.md) · [AI Agent Patterns](../Notes/02-Agent-Patterns.md)
