...
A single AI agent, built four different ways, growing in complexity across three levels. The goal is to understand how each framework approaches the same core problem - and how the AI agent itself evolves as you add memory, planning, and reflection.
