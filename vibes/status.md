...
- Design system: sun-yellow color tokens, prose overrides, audience-toggle CSS (see `src/app/globals.css`; tokens also cataloged in `vibes/GLASS-UI-REDESIGN.md`'s current-state recon)
...
### Near-term
- [ ] **Glassmorphism / "Liquid Glass" UI redesign** - whole-site restyle + new dark mode (toggle, defaults to light) - see `vibes/GLASS-UI-REDESIGN.md` for the plan/estimate (~17 eng-days) and `vibes/glass-ui-redesign-checklist.md` for the 11-section execution checklist. Not started.
...
vibes/                                project tracking & active plans
  GLASS-UI-REDESIGN.md               glassmorphism/dark-mode redesign plan (not started)
  glass-ui-redesign-checklist.md     execution checklist for the above
  status.md                          this file
